...
@Set WORKDRIVE=C
@Set JDK="C:\Program Files\Java\jdk-11.0.5\bin"
...
@set JAVAPROJ=%WORKDRIVE%:\\Users\\%USERNAME%\\Documents\\IntelliJ\\SD
@Set PACKAGE=hashmatching
@Set PACKAGE_PREFIX=edu.ufp.inf.sd.rmi
@Set PACKAGE_PREFIX_FOLDERS=edu/ufp/inf/sd/rmi
@Set SERVICE_NAME_ON_REGISTRY=HashMatchingService
@Set CLIENT_CLASS_PREFIX=HashMatching
@Set SERVER_CLASS_PREFIX=HashMatching
